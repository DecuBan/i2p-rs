...
impl I2pDatagramSocket {
	...
	pub fn bind<A: ToI2pSocketAddrs>(addr: A) -> Result<I2pDatagramSocket, Error> {
		I2pDatagramSocket::bind_via(DEFAULT_API_TCP, addr, SAMOptions::default())
	}
	...
	pub fn bind_via<A: ToSocketAddrs, B: ToI2pSocketAddrs>(
		...
		super::each_i2p_addr(sam_addr, addr, options, I2pDatagramSocket::bind_addr)
			.map_err(|e| e.into())
	}
	...
	pub fn connect<A: ToI2pSocketAddrs>(&self, addr: A) -> Result<(), Error> {
		self.connect_via(DEFAULT_API_TCP, addr, SAMOptions::default())
	}
	...
	pub fn connect_via<A: ToSocketAddrs, B: ToI2pSocketAddrs>(
		...
		super::each_i2p_addr(
			...
			addr,
			options,
			|_sam_addr, _addr, _opts| unimplemented!(),
		)
	}
